      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Welcome to MVRshare ("the Platform", "we", "our", "us"). MVRshare is an open-source community platform
              dedicated to the sharing of MVR files, GDTF patches, 3D scenes, and related assets within the
              professional lighting design community.
            </p>
            <p className="mt-3">
              By creating an account or accessing any part of the Platform, you ("User", "you") agree to be bound
              by these Terms and Conditions ("Terms"). If you do not agree with any part of these Terms, you must
              not use the Platform.
            </p>
            <p className="mt-3">
              These Terms apply to all visitors, registered users, and contributors. We reserve the right to
              update these Terms at any time. Continued use of the Platform after changes constitutes acceptance
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>You are at least 16 years of age (or the applicable age of digital consent in your country).</li>
          ...
          <section>
            ...
            <p>
              ...
              You must notify us immediately at <span className="text-amber-400">legal@mvrshare.com</span> of
          ...
          <section>
            ...
            <p>You agree to use the Platform only for lawful purposes and in a manner that does not infringe
              the rights of others. You must not:</p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-100 mb-3">6. File Upload and Content Policy</h2>
            <p>
              By uploading files or content to MVRshare, you confirm that:
            </p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>You have the right to grant MVRshare the license described in Section 7 below.</li>
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-100 mb-3">7. Intellectual Property and License</h2>
            <p>
              <strong className="text-zinc-100">Your content:</strong> You retain full ownership of all files
              and content you upload to MVRshare. By uploading content, you grant MVRshare a worldwide,
            ...
            <p className="mt-3">
              ...
              You are solely responsible for ensuring the selected license accurately reflects the rights you
              hold and intend to grant.
            </p>
            <p className="mt-3">
              ...
              the property of MVRshare and may not be used without prior written consent.
            </p>
            <p className="mt-3">
              ...
              proof of ownership. We will investigate and take appropriate action.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-zinc-100 mb-3">8. Communications and Newsletter</h2>
            <p>
              ...
              These communications are necessary for the operation of your account and cannot be opted out of
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-100 mb-3">9. Disclaimer and Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-100 mb-3">10. Termination</h2>
            <p>
              ...
              personal data will be removed in accordance with our Privacy Policy. Files you have shared
              may remain available on the Platform unless you explicitly request their removal prior to
              account deletion.
            </p>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-100 mb-3">11. Governing Law</h2>
            <p>
              These Terms are governed by and construed in accordance with the laws of the European Union
              and, where applicable, the laws of France. Any disputes arising under these Terms shall be
              subject to the exclusive jurisdiction of the competent courts.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-zinc-100 mb-3">12. Contact</h2>
            <p>
